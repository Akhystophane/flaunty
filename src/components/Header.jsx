...
return (
   ...
   <div ref={navbarDivRef} className={`fixed top-0 left-0 w-full z-50 border-b border-n-6/0
     ...
     <div className="flex items-center px-5 lg:px:7.5 xl:px-10 max-lg:py-4">
       ...
       {/* Logo avec flex-shrink-0 pour éviter qu'il ne se compresse */}
       <div className="flex-shrink-0">
         <a className="block w-[12rem] xl:mr-4" href="#hero">
             <img src={brainwave} width={190} height={40} alt="brainwave"/>
         </a>
       </div>

       {/* Navigation avec flex-1 pour prendre l'espace restant */}
       <nav className={`${openNavigation ? 'flex' : 'hidden'} 
         opacity-100 fixed top-[5rem] left-0 
         right-0 bottom-0 bg-n-8 lg:static lg:flex 
         flex-1 lg:bg-transparent `}>
